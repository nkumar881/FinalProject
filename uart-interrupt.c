...
void UART1_Handler(void)
{
    ...
    if (UART1_MIS_R & 0x10)
    {
        ...
        byte_received = (char)(UART1_DR_R & 0xFF);//could remove the 0xFF part
        uart_sendChar(byte_received);
        //optional
       // lcd_printf(byte_received);
        //toPrint=byte_received;
        ...
        else
        {
            ...
            //use this for the extra credit part of this lab
